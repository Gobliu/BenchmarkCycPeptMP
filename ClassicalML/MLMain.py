...
def random_regression(mode):
    for split_seed in range(1, 11):
        ...
        # ===== for inference mol length 8 9 only ====
        # test_list = [f'../CSV/Data/mol_length_{i}.csv' for i in [8, 9]]
        # test_csv_path = f"../CSV/Predictions/random/regression/{mode}_mol_length89_seed{split_seed}.csv"
...
def scaffold_regression(mode):
    for split_seed in range(1, 11):
        ...
        # ===== for inference mol length 8 9 only ====
        test_list = [f'../CSV/Data/mol_length_{i}.csv' for i in [8, 9]]
        test_csv_path = f"../CSV/Predictions/scaffold/regression/{mode}_mol_length89_seed{split_seed}.csv"
        # ============================================
...
def random_classification(mode):
    for split_seed in range(1, 11):
        ...
        # ===== for inference mol length 8 9 only ====
        test_list = [f'../CSV/Data/mol_length_{i}.csv' for i in [8, 9]]
        test_csv_path = f"../CSV/Predictions/random/classification/{mode}_mol_length89_seed{split_seed}.csv"
        data = loader_scaffold_split_scaled(test_list, test_list)
        # ============================================
...
def scaffold_classification(mode):
    for split_seed in range(1, 11):
        ...
        # ===== for inference mol length 8 9 only ====
        # test_list = [f'../CSV/Data/mol_length_{i}.csv' for i in [8, 9]]
        # test_csv_path = f"../CSV/Predictions/scaffold/classification/{mode}_mol_length89_seed{split_seed}.csv"
        # ============================================
