    ...
    for model_name in m_names:
        ...
        for split_seed in range(1, 2):
            ...
            if args['mode'] == 'soft':
                ...
                print(train_cp.y.shape, valid_cp.y.shape, test_cp.y.shape)
...
if __name__ == '__main__':
    ...
    # cross_entropy_metric = dc.metrics.Metric(loss_function._create_pytorch_loss(),
    #                                          name='cross_entropy',
    #                                          mode='classification',
    ...
    # rms_dict = {'classification': [cross_entropy_metric, 'cross_entropy'],
    #             'regression': [dc.metrics.Metric(dc.metrics.score_function.rms_score), 'rms_score'],
    #             'soft': [cross_entropy_metric, 'cross_entropy']}
    ...
    if args['split'] == 'scaffold':
        mol_length_list = [6]
        csv_list = [[f'./CSV/Data/mol_length_{i}_test.csv' for i in mol_length_list],
